...
#---------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def matches(self, genome, fromNode, toNode):
        if len(genome.genes) == len(innovationNumbers): #if the number of connections are different then the genoemes aren't the same
            if fromNode.number == self.fromNode and toNode.number == self.toNode:
                ...
                for i in range(len(genome.genes)):
                    if not innovationNumbers.contains(genome.genes[i].innovationNo):
                        return False
