...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, playerID, color, goal_point, screen):
        ...
        # # float[] vision = new float[genomeInputs];//the input array fed into the neuralNet  <- does this come from look?
    ...
    def update(self):
        ...
        vision = player.look() ### <__________Come back to this______
